...
class ItemLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_location" do
    assert_difference('ItemLocation.count') do
      post item_locations_url, params: { item_location: { context: @item_location.context, description: @item_location.description, verified: @item_location.verified } }
    end
  ...
  test "should update item_location" do
    patch item_location_url(@item_location), params: { item_location: { context: @item_location.context, description: @item_location.description, verified: @item_location.verified } }
